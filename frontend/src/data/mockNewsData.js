// Mock News Data - This file can be updated without rebuilding the entire application
export const mockNewsData = {
  featuredNews: [
    ...
    {
      id: 5,
      imageUrl: 'https://imgs.search.brave.com/IaK2v7stsKYLIuv5G6VC9CkBiEsKcwzPKUtkZWDf730/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly91cGxv/YWQud2lraW1lZGlhLm9yZy93aWtpcGVk/aWEvY29tbW9ucy83/Lzc3L0tlYW5lX0Jy/aWRnZV9hbmRfQWxp/X0FtamFkJ3NfQ2xv/Y2ssX1N5bGhldC5q/cGc',
...
// Helper function to get current date for dynamic news
export const getCurrentDate = () => {
  return new Date().toISOString();
};

// Helper function to add new news items
export const addNewsItem = (newsItem) => {
  if (newsItem.isFeatured) {
    mockNewsData.featuredNews.unshift(newsItem);
  } else {
    mockNewsData.trendingNews.unshift(newsItem);
  }
};

// Helper function to update news items
export const updateNewsItem = (newsId, updates) => {
...
// Helper function to delete news items
export const deleteNewsItem = (newsId) => {
  mockNewsData.featuredNews = mockNewsData.featuredNews.filter(news => news.id !== newsId);
  mockNewsData.trendingNews = mockNewsData.trendingNews.filter(news => news.id !== newsId);
};
