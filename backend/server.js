...
const corsOptions = {
  ...
  allowedHeaders: ['Content-Type', 'Authorization', 'Cache-Control', 'Pragma', 'X-Requested-With', 'Accept', 'Accept-Language'],
  credentials: true,
...
// Extra safety: set CORS headers on all responses (covers any route/errors)
